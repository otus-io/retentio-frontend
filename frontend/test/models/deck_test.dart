    ...
    group('fromJson', () {
      test('parses deck with owner as object', () {
        final json = {
          ...
          'name': 'Test Deck',
          'templates': [0, 1],
          'stats': {'unseen_cards': 5, 'facts_count': 10, 'due_cards': 2, 'cards_count': 20},
          'rate': 0.95,
    ...
    group('toJson', () {
      test('serializes deck correctly', () {
        final deck = Deck(
          ...
          name: 'My Deck',
          templates: [0],
          stats: DeckStats(unseenCards: 5, factsCount: 10, dueCards: 2, cardsCount: 20),
          rate: 0.9,
    ...
    group('progress', () {
      test('returns 0 when cardsCount is 0', () {
        final deck = Deck(
          ...
          name: 'n',
          templates: [],
          stats: DeckStats(unseenCards: 0, factsCount: 0, dueCards: 0, cardsCount: 0),
          rate: 0,
      ...
      test('clamps progress to 100', () {
        final deck = Deck(
          ...
          name: 'n',
          templates: [],
          stats: DeckStats(unseenCards: 0, factsCount: 0, dueCards: 0, cardsCount: 10),
          rate: 0,
          owner: DeckOwner(username: '', email: ''),
          fields: [],
          minInterval: 0,
    ...
    group('totalCards, learnedCards, reviewCards', () {
      test('returns correct values from stats', () {
        final deck = Deck(
          ...
          name: 'n',
          templates: [],
          stats: DeckStats(unseenCards: 8, factsCount: 20, dueCards: 5, cardsCount: 25),
          rate: 0,
          owner: DeckOwner(username: '', email: ''),
          fields: [],
          minInterval: 0,
