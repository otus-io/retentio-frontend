...
class _VideoProgressIndicatorState extends State<CustomVideoPlayerProgressBar> {
  ...
  void initState() {
    super.initState();
    widget.customVideoPlayerController.videoPlayerController.addListener(
      updateWidgetListener,
    );
  }

  @override
  void deactivate() {
    widget.customVideoPlayerController.videoPlayerController.removeListener(
      updateWidgetListener,
    );
    super.deactivate();
  }
